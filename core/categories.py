...
_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "Mejeri & Ägg": [
        "mjölk", "yoghurt", "yogh", "smör", "grädde", "ägg", "kvarg",
        "filmjölk", "crème fraîche", "creme fraiche", "bregott", "skyr", 
        "keso", "kesella",
    ],
    "Ost": [
        "mozzarella", "halloumi", "feta", "ricotta", "mascarpone",
        "herrgård", "prästost", "präst", "grevé", "lagrad ost", "manchego",
        "gammelknas", "gruyere", "saint agur", "burrata", "danablu",
        "castello", "gouda", "brie", "camembert", "cheddar", "emmentaler",
    ...
    "Vego": [
        "tofu", "tempeh", "seitan", "quorn", "oumph", "beyond meat",
        "impossible", "vego", "vegan", "vegansk", "vegetarisk",
        "sojafärs", "ärtfärs", "linsfärs", "kikärtefärs",
        "blomkålsbiff", "jackfruit",
    ],
    "Fisk & Skaldjur": [
    ...
    "Frukt": [
        ...
        "clementin", "citrus", "björnbär", "blåbär", "cantaloupe"
    ],
    "Grönsaker": [
        ...
        "fänkål", "ruccola", "rucola", "rotselleri", "koriander", "persilja",
        "gräslök", "portabello", "champinjon", "salvia", "sparris", "dill"
    ],
    "Snacks & Godis": [
        "chips", "godis", "choklad", "popcorn", "lakrits",
        "gelé", "skumgodis", "kex", "nötmix", "cheez doodles",
        "smash", "nachos", "tortillachips", "peanuts", "jordnöt",
        "studentmat", "polly", "lördagsgodis",
    ],
    "Bröd & Bakverk": [
    ...
    "Skafferi": [
        "müsli", "granola", "cornflakes", "flingor",
        "mjöl", "konserv", "sås", "olja", "olivolja", "socker", "salt", "krydda",
        "senap", "ketchup", "majonäs", "vinäger", "buljong", "tomatsås",
        "honung", "sylt", "marmelad", "mandel", "cashew", "nötter",
        "kikärt", "linser", "bambu", "bön",
        "tapenade", "pesto", "oliv", "krossade tomater", "kokosmjölk", "soja",
        "teriyakisås", "sriracha", "gochujang", "harissa", "chipotlesås", "sambal oelek",
        "wasabi", "miso", "gryn", "panko", "kronärtskock", "kimchi"
    ],
    "Pasta, Ris & Gryn": [
        "pasta", "ris", "couscous", "bulgur", "quinoa", "gemelli", "fusilli", "penne",
        "spaghetti", "tagliatelle", "farfalle", "orzo", "risoni", "canneloni",
        "gnocchi", "lasagneplattor", "tortellini", "ravioli", "linguine", "havregryn",
        "mannagryn", "quinoa", "nudlar", "fusilloni", "udon", "tortiglioni"
    ],
    "Kryddor": [
        "peppar", "paprikapulver", "curry", "kanel", "salt", "krydda", "kummin",
        "lökpulver", "oregano", "timjan", "rosmarin", "basilika", "spiskummin",
        "kardemumma", "gurkmeja", "korianderpulver", "chilipulver", "cayenne",
        "muskot", "ingefärspulver", "vitlökspulver",
    ],
    "Deli & Färdigmat": [
        "sushi", "pizza", "soppa", "färdigmat", "deli", "hummus", "tzatziki",
        "guacamole", "paj", "quiche", "lasagne", "färdigrätt", "wokrätt",
        "lunchbaren", "lunchbar", "lunch", "salladsbar", "smörgås", "smörgåstårta",
        "wrap", "falafel", "kebab", "gyros", "tacos", "burrito", "quesadilla",
        "moussaka", "gryta", "soppa",
    ],
    "Kosttillskott & Hälsa": [
        "protein", "kosttillskott", "kapslar", "omega", "vitamin",
        "järntablett", "magnesiumtablett", "collagen", "probiotika",
        "proteinpulver", "proteinbar", "whey", "kreatin", "bcaa",
    ],
    "Fryst": [
        "fryst", "glass", "frysta",
    ],
    "Hushåll": [
        "batteri", "bestick", "aluminiumfolie", "plastfolie", "bakplåtspapper",
        "sopsäck", "papperspåse", "hushållspapper", "köksrulle", "tvättsvamp",
        "skursvamp", "diskborste", "moppar", "skovård", "glödlampa",
        "tändstickor", "ljus", "värmeljus", "ziplock", "matlåda",
    ],
    "Hygien & Rengöring": [
        ...
        "hudkräm", "hårspray", "intim", "toa", "dusch", "vätskeers"
    ],
    "Du glömde handlingskassen": [
        "plastkasse"
    ],
}
