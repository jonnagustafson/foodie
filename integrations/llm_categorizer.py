...
def _system_prompt() -> str:
    ...
    return (
        ...
        "1. canonical_name: the generic product, stripped of brand, size, "
        "packaging, and quantity. Use the singular Swedish noun, capitalized "
        "(e.g. 'Arla Mellanmjölk 1,5% 1l' -> 'Mjölk'; '*Garant Ägg Frigående "
        "12-p' -> 'Ägg'). Items that are the same product MUST get the exact "
        "same canonical_name regardless of brand.\n"
